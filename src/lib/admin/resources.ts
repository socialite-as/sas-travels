...
export const RESOURCES: Resource[] = [
  ...
  {
    key: "corporate_enquiries",
    table: "corporate_enquiries",
    label: "Corporate Enquiries",
    singular: "Enquiry",
    primaryColumn: "company_name",
    orderBy: { column: "created_at", ascending: false },
    fields: [
      { name: "company_name", label: "Company", type: "text", required: true, listVisible: true },
      { name: "contact_name", label: "Contact name", type: "text", required: true, listVisible: true },
      { name: "email", label: "Work email", type: "text", required: true, listVisible: true },
      { name: "phone", label: "Phone", type: "text" },
      { name: "event_type", label: "Event type", type: "text", listVisible: true },
      { name: "team_size", label: "Team size", type: "number", listVisible: true },
      { name: "destination", label: "Destination", type: "text" },
      { name: "preferred_dates", label: "Preferred dates", type: "text" },
      { name: "budget_per_person", label: "Budget per person (INR)", type: "number" },
